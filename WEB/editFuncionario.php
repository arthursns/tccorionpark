...
<link rel="stylesheet" href="css/editfucionario.css">
            ...
            <form action="editFuncionarioModel.php" method="POST">
                ...
                <div class="text">
                    ...
                    <div class="item">
                        ...
                        <select name="cargoId" id="cargo">
                            ...
                            <?php while ($cargos = sqlsrv_fetch_array($exec4)) { ?>
                                <option <?php if ($dado['id_cargo'] == $cargos['id_cargo']) {
                                            echo 'selected';
                                        } ?> value="<?php echo $cargos['id_cargo']; ?>">
                    ...
                    <div class="item">
                        ...
                        <a href="cadCargo.php">Não encontrou o cargo? <b>Clique aqui</b> para cadastra-lo</a>
                    </div>
                    ...
                    <div class="item">
                        ...
                        <select name="nivelAcesso" id="nivelAcesso">
                            ...
                            <?php while ($nivelAcesso = sqlsrv_fetch_array($exec5)) { ?>
                                <option <?php if ($dado3['id_nivel_acesso'] == $nivelAcesso['id_nivel_acesso']) {
                                            echo 'selected';
                                        } ?> value="<?php echo $nivelAcesso['id_nivel_acesso']; ?>">
